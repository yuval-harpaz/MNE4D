...
# import numpy
# read the data
raw = mne.fiff.Raw('sagit_raw.fif',preload=True)
# bandpass filter
picks = mne.fiff.pick_types(raw.info, meg=True)
raw.band_pass_filter(picks, 1.0, 50.0, filter_length=2048,n_jobs=4)
raw.save('sagitf_raw.fif')
# averaging
# import mne
# raw = mne.fiff.Raw('sagitf_raw.fif')
